...
from compass.ocean.tests.global_ocean.mesh.arrm6to30 import ARRM6to30BaseMesh
...
class Mesh(TestCase):
    ...
    def __init__(self, test_group, mesh_name,  # noqa: C901
        ...
        elif mesh_name in ['ARRM6to30', 'ARRMwISC6to30']:
            base_mesh_step = ARRM6to30BaseMesh(self, name=name, subdir=subdir)
